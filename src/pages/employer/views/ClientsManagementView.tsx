...
const ClientsManagementView: React.FC<Props> = () => {
  const [statusFilter, setStatusFilter] = useState("");
  const [search, setSearch] = useState("");
  const [showCreate, setShowCreate] = useState(false);
  const [editingClient, setEditingClient] =
    useState<ClientCompanyEnhanced | null>(null);
  ...
  const [createRateCard, { isLoading: creatingRC }] =
    useCreateRateCardMutation();
  ...
  const handleCreateRateCard = useCallback(async () => {
    ...
    try {
      await createRateCard({
        ...
        ...rcForm,
      } as Parameters<typeof createRateCard>[0]).unwrap();
  ...
  const columns: DataTableColumn<ClientCompanyEnhanced>[] = useMemo(
    () => [
      { key: "name", header: "Company Name" },
      {
        key: "legalName",
        header: "Legal Name",
        render: (c) => c.legalName || "—",
      },
      {
        key: "billingEmail",
        header: "Billing Email",
        render: (c) => c.billingEmail || "—",
      },
      ...
      },
      {
        ...
        render: (c) => (
          <div style={{ display: "flex", gap: 4 }}>
            ...
            <Button size="sm" onClick={() => setSelectedClientId(c._id)}>
              Rate Cards
            </Button>
          </div>
        ),
    ...
    () => [
      {
        key: "personName",
        header: "Worker",
        render: (r) => r.personName || r.personId,
      },
      {
        key: "jobTitle",
        header: "Job Title",
      ...
      },
      {
        key: "billRate",
        header: "Bill Rate",
        render: (r) => fmtCurrency(r.billRate),
      },
      {
        key: "payRate",
        header: "Pay Rate",
        render: (r) => fmtCurrency(r.payRate),
      },
      ...
      <>
        ...
        {showRateCardForm && (
          ...
          >
            <button
              type="button"
              aria-label="Close new rate card dialog"
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                <Input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setRcForm((p) => ({ ...p, personId: e.target.value }))
                  }
                />
                <Input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setRcForm((p) => ({ ...p, personName: e.target.value }))
                  }
                />
                <Input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setRcForm((p) => ({ ...p, jobTitle: e.target.value }))
                  }
                />
                <div
                  style={{
                ...
                >
                  <Input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      setRcForm((p) => ({ ...p, billRate: +e.target.value }))
                    }
                  />
                  <Input
                    type="number"
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      setRcForm((p) => ({ ...p, payRate: +e.target.value }))
                    }
                  />
                  <Input
                    type="number"
                ...
                >
                  ...
                  <Button
                    ...
                    disabled={creatingRC || !rcForm.personId}
                  >
    ...
    <>
      ...
      {showCreate && (
        ...
        >
          <button
            type="button"
            aria-label="Close client form dialog"
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              >
                <Input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setFormData((p) => ({ ...p, billingEmail: e.target.value }))
                  }
                />
                <Input
                  placeholder="Phone"
